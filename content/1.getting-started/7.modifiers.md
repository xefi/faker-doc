...
$faker->lowercase()->sentences(); // my sentence lowercased
```
...
$faker->uppercase()->sentences(); // MY SENTENCE UPPERCASED
```

## Ucfirst

Put your string in capitalize:
...
$faker->ucfirst()->sentences(); // My sentence capitalized
```
