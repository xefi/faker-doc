...
$faker->unique()->number(1, 2); // 1
$faker->unique()->number(1, 2); // 2
$faker->unique()->number(1, 2); // Error too many tries
```
...
$faker->unique('my-seed')->number(1, 2); // 1
$faker->unique('my-seed')->number(1, 2); // 2
$faker->unique('my-other-seed')->number(1, 2); // 1
```
...
$faker->valid(function ($number) {return $number % 2 === 0; })->number(1, 100); // Even numbers
$faker->valid(fn ($number) => $number % 2 !== 0)->number(1, 100); // Odd numbers
